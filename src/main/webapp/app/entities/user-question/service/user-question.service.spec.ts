...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../user-question.test-samples';

import { RestUserQuestion, UserQuestionService } from './user-question.service';

const requireRestSample: RestUserQuestion = {
...
describe('UserQuestion Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a UserQuestion', () => {
